package com.unistack.tamboo.commons.utils;//package com.unistack.tamboo.commons.tools.util;
...
/**
 * Created by Gyges Zean on 15/12/31.
 */
public class OkHttpUtils {
    ...
    public static String post(String url) throws IOException {
        return post(url, new HashMap<Object, Object>());
    }
    ...
    public static String post(String url, Map<Object, Object> params) throws IOException {
        ...
        for (Object s : params.keySet()) {
            builder.add((String) s, (String) params.get(s));
        }
    ...
    public static OkHttpResponse put(String url) throws IOException {
        RequestBody requestBody = RequestBody.create(JSON_TYPE, new JSONObject().toJSONString());
        Request request = new Request
                .Builder()
                .url(url)
                .put(requestBody)
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(OkHttpUtils.get("http://192.168.0.110:18081/subjects/admin-383-tamboo_keep_test-1535448307464-B1-value"));
    }
