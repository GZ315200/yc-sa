...
public class KafkaStatusBackingStore implements StatusBackingStore {
    ...
    public static  String RUNNER_STATUS_PREFIX = "status-runner-";

    private Time time;

    private  Map<String, CacheEntry<RunnerStatus>> runners;

    public static  String STATE_KEY_NAME = "state";
    public static  String TRACE_KEY_NAME = "trace";
    public static  String RUNNER_ID_KEY_NAME = "runner_id";

    private String topic;
//    private  Table<String, Integer, CacheEntry<RunnerStatus>> tasks;
    private KafkaTopicBaseLog<String, byte[]> kafkaTopicBaseLog;

    private JsonConverter converter = new JsonConverter();

    public static  Logger log = LoggerFactory.getLogger(KafkaStatusBackingStore.class);
...
//        this.tasks = new Table<>();
    ...
    private KafkaTopicBaseLog<String, byte[]> createKafkaBasedLog(String topic, Map<String, Object> producerProps,
                                                                  ...
                                                                  Callback<ConsumerRecord<String, byte[]>> consumedCallback,
                                                                   NewTopic topicDescription,  Map<String, Object> adminProps) {
    ...
    private void sendRunnerStatus( RunnerStatus runnerStatus, boolean safeWrite) {
    ...
    private <V extends AbstractStatus> void send( String key,  V status,
                                                  CacheEntry<V> entry,  boolean safeWrite) {
         int sequence;
        synchronized (this) {
         ...
         byte[] value = status.state() == RunnerStatus.State.DESTROYED ? null : serialize(status);
